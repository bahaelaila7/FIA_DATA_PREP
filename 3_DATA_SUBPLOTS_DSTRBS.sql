...
FROM (
  ...
  SELECT DSCOND.STATECD, DSCOND.UNITCD, DSCOND.COUNTYCD, DSCOND.PLOT , DSCOND.SUBP, DSCOND.plt_cns, DSCOND.invyrs, DSCOND.measdates, DSCOND.subp_num_meas,
  ...
  FROM (
    ...
    GROUP BY DS.STATECD, DS.UNITCD, DS.COUNTYCD, DS.PLOT , DS.SUBP, DS.plt_cns, DS.invyrs, DS.measdates, DS.subp_num_meas, v.plt_cn, v.invyr
  ) AS DSCOND

  GROUP BY DSCOND.STATECD, DSCOND.UNITCD, DSCOND.COUNTYCD, DSCOND.PLOT , DSCOND.SUBP, DSCOND.plt_cns, DSCOND.invyrs, DSCOND.measdates, DSCOND.subp_num_meas
) AS DSD;
COMMIT;
