...
POLY_PATH = "../LANDFIRE/firezones/conus_mz_0k.shp"         # replace with your polygons
...
joined[['STATECD','UNITCD','COUNTYCD','PLOT', 'LON','LAT','DATUM','ECOSUBCD', 'ZONE_NUM']].to_sql(OUT_TABLE, eng_out, if_exists='replace', index=False)
