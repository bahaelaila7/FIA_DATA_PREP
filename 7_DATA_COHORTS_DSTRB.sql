...
CAST ( round(v.age_calc) AS INTEGER) age_calc, sum(v.drybio_ag*v.TPA_UNADJ)*0.112085 AGB, sum(v.TPA_UNADJ) tree_count, bool_and(STDORGCD=1) as planted_stand
...
v(PLT_CN, drybio_ag,statuscd, age_calc, measdate, TPA_UNADJ, STDORGCD)
